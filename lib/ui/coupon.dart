...
import 'package:kudapan/model/coupon_model.dart';
import 'package:kudapan/ui/coupon_detail.dart';
          ...
          child: Row(
            ...
            children: [
              buildCacheNetworkImage(
                  height: 40,
                  url: GLOBAL_URL +
                      '/assets/images/apps/food_delivery/merchant_logo.png',
                        ...
                        Row(
                          children: [
                            ...
                            Text('Expiring in ' + couponData.day + ' days',
                                style: GlobalStyle.couponExpiringDate),
                          ],
                        ),
                        Spacer(),
                        GestureDetector(
