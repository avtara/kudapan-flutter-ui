...
import 'package:kudapan/ui/reusable/shimmer_loading.dart';
import 'package:flutter/material.dart';

class CategoryMenuPage extends StatefulWidget {
  final String title;

  const CategoryMenuPage({Key? key, this.title = 'Food Around You'})
      : super(key: key);
            ...
            child: ListView(
              ...
              children: [
                FilterChip(
                  label: Text('Nearby'),
                  labelStyle:
                      TextStyle(color: _isNearby ? Colors.white : Colors.black),
                  selected: _isNearby,
                ...
                FilterChip(
                  ...
                  labelStyle: TextStyle(
                      color: _isBestSeller ? Colors.white : Colors.black),
                ...
                FilterChip(
                  label: Text('Promo'),
                  labelStyle:
                      TextStyle(color: _isPromo ? Colors.white : Colors.black),
                  selected: _isPromo,
                  onSelected: (bool selected) {
                    refreshData();
                    setState(() {
                ...
                FilterChip(
                  ...
                  labelStyle: TextStyle(
                      color: _isNewComers ? Colors.white : Colors.black),
                ...
                FilterChip(
                  label: Text('Drink'),
                  labelStyle:
                      TextStyle(color: _isDrink ? Colors.white : Colors.black),
                  selected: _isDrink,
                  onSelected: (bool selected) {
                    refreshData();
                    setState(() {
