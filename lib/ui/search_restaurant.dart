...
import 'package:kudapan/model/search_restaurant_model.dart';
...
class _SearchRestaurantPageState extends State<SearchRestaurantPage> {
  ...
  void _getData() {
    _searchData = [
      SearchRestaurantModel(id: 1, words: 'chicken'),
      SearchRestaurantModel(id: 2, words: 'fried rice'),
      SearchRestaurantModel(id: 3, words: 'steam'),
      SearchRestaurantModel(id: 4, words: 'salad'),
      SearchRestaurantModel(id: 5, words: 'beef'),
    ];
  }
