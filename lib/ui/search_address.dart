...
import 'package:kudapan/model/search_address_model.dart';
import 'package:kudapan/ui/add_address.dart';
            ...
            children: [
              ...
              Flexible(
                child: Column(
                  ...
                  children: [
                    Text(_addressData[index].place,
                        style: TextStyle(color: Colors.black, fontSize: 14),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis),
                    SizedBox(height: 2),
                    Text(_addressData[index].address,
