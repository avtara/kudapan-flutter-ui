...
class _DetailFoodPageState extends State<DetailFoodPage> {
            ...
            child: ListView(
              ...
              children: [
                buildCacheNetworkImage(
                    ...
                    height: bannerHeight,
                    url: GLOBAL_URL +
                        "/assets/images/apps/food_delivery/food/1.jpg"),
          ...
          Opacity(
            ...
            child: Container(
              ...
              child: AppBar(
                ...
                centerTitle: true,
                title: Text('Chicken Rice Teriyaki',
      ...
      children: [
        Container(
          ...
          child: Row(
            ...
            children: [
              Flexible(
                child: Text('Chicken Rice Teriyaki',
                    style: GlobalStyle.detailFoodTitle,
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis),
              ),
              Text('\$ ' + _globalFunction.removeDecimalZeroFormat(4.5),
                  style: GlobalStyle.detailFoodPrice),
            ],
          ),
        ),
        Container(
            ...
            child: Text(
              ...
              style: GlobalStyle.detailFoodDesc,
              maxLines: 3,
              overflow: TextOverflow.ellipsis,
            )),
        SizedBox(height: 16)
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              _radioSize(
                  value: 'large', primaryText: 'Large', secondaryText: '+ \$1'),
            ],
          ),
        )
      ],
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              _radioSpicy(
                  value: 'normal', primaryText: 'Normal', secondaryText: '0'),
              Divider(
                height: 32,
                color: Colors.grey[400],
              ),
          ...
          child: Column(
            children: [
              Row(
                children: [
                  Text('Special Instructions',
                      style: GlobalStyle.detailFoodOptions),
                  SizedBox(width: 8),
              ...
              TextField(
                ...
                style: TextStyle(color: BLACK77, fontSize: 14),
              )
            ],
          ),
        )
        ...
        children: [
          ...
          Text(primaryText,
              style: TextStyle(
                  ...
                  color: BLACK77,
                  fontWeight:
                      _size == value ? FontWeight.bold : FontWeight.normal)),
          Spacer(),
          Text(secondaryText,
              style: TextStyle(
                fontSize: 13,
        ...
        children: [
          ...
          Text(primaryText,
              style: TextStyle(
                  ...
                  color: BLACK77,
                  fontWeight:
                      _spicy == value ? FontWeight.bold : FontWeight.normal)),
          Spacer(),
          Text(secondaryText,
              style: TextStyle(
                fontSize: 13,
  ...
  Widget _checboxChicken(
      {value = 'breast', primaryText = 'Chicken Breast', secondaryText = '0'}) {
    return GestureDetector(
      behavior: HitTestBehavior.translucent,
      onTap: () {
        setState(() {
